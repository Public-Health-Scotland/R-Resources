...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri("\\\\freddy/dept/PHIBCS/Corp Gov/Stats Gov/User Groups/R/Training/R guidance for analysts/images/NSS_logo.png"),
               alt = 'logo',
...
![Example of software centre](images/software_centre_example.PNG)
...
![RStudio](images/RStudio_example.png)
...
![Example of blank R script](images/r_script_example.png)
...
![x and y variables in environment](images/xy_environment_example.png)
...
![Loaded packages](images/load_packages.png)
...
![Viewing data in R](images/view_data_example.PNG)
...
![Filtering data in R](images/view_then_filter.png)
...
![Factor vs Character](images/factor_vs_character.png)
...
![Magritte](images/MagrittePipe.jpg)
