...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri(file.path("//freddy/dept/PHIBCS/Corp Gov/Stats Gov/User Groups/R/Training/R Guidance for PHI/images/R_Guidance1_logo.png")),
               alt = "NSS logo",
...
![Loaded packages](images/R_Guidance6_packages.png)
