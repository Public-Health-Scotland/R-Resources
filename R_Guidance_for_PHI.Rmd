...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri(here("R Guidance for PHI Formatting/images//R_Guidance1_logo.png")),
               alt = "NSS logo",
...
![Example of software centre](R Guidance for PHI Formatting/images/R_Guidance2_software_centre.PNG)
...
![RStudio](R Guidance for PHI Formatting/images/R_Guidance3_RStudio.png)
...
![Example of blank R script](R Guidance for PHI Formatting/images/R_Guidance4_R_script.png)
...
![x and y variables in environment](R Guidance for PHI Formatting/images/R_Guidance5_environment.png)
...
![Loaded packages](R Guidance for PHI Formatting/images/R_Guidance6_packages.png)
...
![Viewing data in R](R Guidance for PHI Formatting/images/R_Guidance7_view_data.PNG)
...
![Filtering data in R](R Guidance for PHI Formatting/images/R_Guidance8_view_filter.png)
...
![Factor vs Character](R Guidance for PHI Formatting/images/R_Guidance9_factor_character.png)
...
![Magritte](R Guidance for PHI Formatting/images/R_Guidance10_pipe.jpg)
...
```{r, include=FALSE}
# detach to stop tidylog output appearing in further sections.
